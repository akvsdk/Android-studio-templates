...
<!--merge 表示需要合并到指定文件的内容 （表示AndroidManifest声明新建的Activity） -->
   <merge from="root/AndroidManifest.xml.ftl"
    ...
    <instantiate from="root/res/layout/activity_main.xml.ftl" 
					to="${escapeXmlAttribute(resOut)}/layout/activity_${Model}_${activity_layout}.xml" />
    <instantiate from="root/src/app_package/MvpActivity.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/${Model}/ui/activity/${ActivityName}.java" />
    ...
    <instantiate from="root/src/app_package/MvpBean.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/${Model}/bean/${BeanName}.java" />
</recipe>
